...
openstack network create floating --external --provider-network-type vlan --provider-physical-network datacentre --provider-segment 158
openstack subnet create floating-subnet --network floating --no-dhcp --gateway 172.21.158.1 --allocation-pool start=172.21.158.120,end=172.21.158.254 --dns-nameserver 8.8.8.8 --subnet-range 172.21.158.0/24
